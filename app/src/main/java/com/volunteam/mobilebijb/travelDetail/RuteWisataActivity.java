...
public class RuteWisataActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdialog = ProgressDialog.show(RuteWisataActivity.this, "",
        ...
        destionationloc = new LatLng(-6.8921,108.398);
...
//        }
        ...
        if (mMap == null) {
            MapWisataFragment mapWisataFragment = ((MapWisataFragment) getSupportFragmentManager().findFragmentById(R.id.map));

            ((MapWisataFragment) getSupportFragmentManager().findFragmentById(R.id.map))
                    .setListener(new MapWisataFragment.OnTouchListener() {
                        @Override
                        public void onTouch() {

                        }
                    });
            mapWisataFragment.getMapAsync(this);
        }
